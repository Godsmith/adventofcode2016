...
def test_across_circle_winning_elf2():
    assert AcrossElfCircle(5).winning_elf2 == 2
    assert AcrossElfCircle(397).winning_elf2 == 154


def test_across_circle_winning_elf3():
